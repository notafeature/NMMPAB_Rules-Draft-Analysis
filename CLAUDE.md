...
| `redesign/` | The working folder behind the July 26 redesign: brief, prototypes, audits. Nothing in it is served. Scheduled for removal in the layout move; recoverable from history |
