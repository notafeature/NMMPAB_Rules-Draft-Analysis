...
**Read against practicum working draft v9**, which is on `main`. Its `amendments/SOURCE-OF-TRUTH.md` assigns to this document each of the items it drafts or records: the 7.35.3.14 C registration fix "belongs at 7.35.3.11 or 7.35.3.20"; the three headings still reading 7.34.3 after that draft corrects two are 7.34.3.13, 7.34.3.23 and 7.34.3.25; and the conflict between 7.35.3.19 K and 7.35.3.10 D(1) is left for whoever reaches 7.35.3.10. Addendum B records every dependency in both directions.
...
| File | What it is |
|---|---|
| `7.35.3-remainder-amendments-v1.pdf` | The document. Side-by-side redline in four parts, plus four addenda |
...
One document, 37 pages, in four parts with the addenda at the end. It follows `amendments/7.35.3-practicum-amendments-v9.pdf` in every respect that document settled:
