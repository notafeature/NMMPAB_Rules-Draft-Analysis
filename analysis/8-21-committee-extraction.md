# Training and Education Committee, August 21, 2026: record in progress

This record was begun while the meeting was underway, from a live auto-generated transcript and from screenshots of the document screen-shared in the meeting. The transcript was still recording at the last capture, and the record ends where it ends. It is to be reconciled against the department's posted recording and minutes when they appear.

## Sources and their limits

- **Live transcript.** Notion page "Training and Education - 8/21", ID `3ac6cd30ecc84e1a8b442dad1616e74e`, in the Committee Meetings Calendar. Auto-generated, and it carries no speaker labels. A speaker is named below only where the surrounding text fixes the attribution, and the basis is stated. The auto transcript misrenders names; spellings are corrected to the standing list where the person is identifiable (it renders Zurlo as "Ixerlo", Burgard as "Burkhardt", Leeman as "Lehman"). Names not on the standing list are given as the transcript renders them, and may be wrong.
...
Friday, August 21, 2026, 9:00 to 11:00 AM MDT, on Microsoft Teams, hosted and recorded by the department. Basis: the Notion page properties and header. Brenda Burgard chaired. Dominic Zurlo, director of the Center for Medical Cannabis and Psilocybin, opened the meeting and ran the screen share; basis: the opening self-introduction, which the auto transcript renders as "Dr. Donna Ixerlo," with "Dominic" used throughout the rest of the transcript. Jorge, who ordinarily runs the documents, was on leave.
...
In the discussion that followed, Denali made two recommendations: drop the department's two-group requirement to one group, for the feasibility of training programs in rural communities, and remove the 10-hour mentoring on the ground that the case presentation and consultation, now integrated into the department's practicum, delivers the licensed-provider feedback the mentoring was meant to provide. Zurlo defended keeping the mentorship as support for graduates who want it. The chair supported the mentorship from her own experience, citing the post-program mentorship in EMDR certification. At the last capture, Larry Leeman had begun a question about how the case presentation and consultation works when it is included in the practicum hours; the question and its answer are not yet in this record.
