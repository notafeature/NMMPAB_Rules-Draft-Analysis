...
The blocks below are generated by a tool. **Never hand-edit them.** Edit the tool, run it.
...
| Starting licenses, routes, and steps | `tools/sync-pathways.py` | `pathways.html` |
| Status surfaces | `tools/sync-status.py` | `index.html`, `hours.html`, `eligibility.html`, `training-hours-record.html` |
