...
CHANGED = {
    ...
    "rules-draft-2026-07-23-published":
        ...
        "with the hearing anticipated for early October. "
...
REVISIONS = {
    ...
    "index": [
        ("August 26, 2026", "The front page flipped to the August 25 publication: the plaque, the portals, and the what-changed column carry the revised proposed rule, the amendments to 7.35.2 NMAC, and the October 2 hearing fixed by notice, with the status surfaces regenerated by tools/sync-status.py."),
        ("August 24, 2026", "An accuracy pass corrected the front page: the July 23 column reports the August 28 hearing as set aside rather than as what the hearing runs on, the eligibility portal counts thirty-seven starting points, and the October 2 hearing moved from the Scheduled list to its own Anticipated label."),
        ...
        ("August 24, 2026", "The full content pass to the current state: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules. The plaque, the procession, the status items, and the Scheduled column now say so, with the September 4 and September 11 meetings and the anticipated early-October hearing listed."),
        ("August 21, 2026", "The plaque, the comment portal, and the status surfaces now carry the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date. The Scheduled column lists the August 25 publication, the September 4 committee meeting, and the anticipated hearing."),
    ...
    "rule": [
        ("August 26, 2026", "Two definitions notes entered: the clinician definition does not cover the certifying clinician, whose subtype it anchors, because it reaches only the three-session medical services; and the qualified-patient definition substitutes certifying clinician where the Medical Psilocybin Act's own definition says clinician, placing the statutory appropriateness judgment in the number-holding role."),
        ("August 26, 2026", "An open note entered at 7.35.3.11: the other-approved-location application requires proof of ownership or a signed statement from the property owner acknowledging program participation on the premises, so a renting patient needs the landlord's signature to be treated at home, with the landlord-approval and privacy question raised at the August 21 committee meeting noted."),
        ("August 26, 2026", "A definitions section entered between 7.35.3.7 and .8, generated from the amendments extraction: the twenty-five program-side definitions of the amended 7.35.2.7 verbatim in the amendment's own strike-and-add notation, each cited to its page, with notes on the contested certifying-clinician scope, the rewritten practitioner, the struck guide, and where the qualifying conditions bind the curriculum."),
        ("August 26, 2026", "Regenerated from the August 25 extraction by tools/build-rule-page.py, whose chrome was brought current so the generator runs again instead of being mirrored by hand: all twenty-eight sections of the revised text, the annotations rewritten for what changed, the four heading misprints corrected in the text and the one that persists noted at 7.35.3.25."),
        ("August 24, 2026", "Reframed as the last published text: the July 23 publication and its August 28 hearing were set aside, and the kicker and lede state the set-aside. The annotation notes at 7.35.3.18 and .19 now state the recommendation at its August 21 position, 80 didactic hours and a staged practicum of 102 or 114, in place of the July 27 figures; mirrored into tools/build-rule-page.py. The text is unchanged."),
        ("August 21, 2026", "The kicker now states the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date. Mirrored into tools/build-rule-page.py, which owns this page."),
    ...
    "record": [
        ("August 26, 2026", "The register gained the enabling statute: Senate Bill 219, the Medical Psilocybin Act, as enacted in 2025, with a chain event at its effective date. The site had cited the Act throughout without holding it."),
        ("August 26, 2026", "The chain flipped to the August 25 publication: a filing event with the revised rule, the 7.35.2 amendments, and the hearing notice attached, the July 23 row restated as superseded, the October 2 hearing moved from Anticipated to Scheduled, and the hearing-notice gap closed."),
        ("August 24, 2026", "An accuracy pass corrected the page: the October 2 hearing event is labeled Anticipated rather than Scheduled, the update stamp carries the date of the latest revision, and the individual-certifications item of the July 23 entry cites 7.35.3.9 (E) and (F) rather than (A)."),
        ("August 24, 2026", "The chain re-based to the current state: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules. The August 14 board meeting entered the chain as a meeting event, with the set-aside on its record, a gap row for its unposted recording and the missing set-aside notice, and the September 11 board meeting scheduled."),
        ("August 21, 2026", "The August 21 committee meeting entered the chain as a meeting event: both hours proposals reviewed side by side, no vote taken, and the schedule restated, the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date. The hearing-notice gap now points at the anticipated October 2 hearing, and a gap row records that no recording or transcript of the August 21 meeting is held here yet."),
    ...
    "hours": [
        ("August 26, 2026", "The model re-based to the August 25 published position as the default: the module total 80, the practicum 100 or 120 with the case-presentation evaluation stated, mentoring 10, beside the recommendation's August 21 position; the role toggle reads Practitioner, and the source note quotes the revised text."),
        ("August 24, 2026", "An accuracy pass corrected the sourcing note, which described the model's two positions as both from August 21, and the off-preset label, which now reads matching neither position."),
        ("August 24, 2026", "Role vocabulary entered the site's own voice: the middle role is the Licensed Provider, the recommendation's name for the role the published text calls the practitioner, and the screening role is written certifying clinician / medical screener, the recommendation's proposed rename, still being pushed. Verbatim quotes and provision names keep the documents' own words."),
        ("August 24, 2026", "The model re-based to two positions: the recommendation, at its August 21 position of 80 classroom hours and a staged practicum of 102 or 114 hours with nothing further required after it, as the default, and the last published text of July 23, since set aside, as what it replaced. Dr. Anne Metz's July 17 figures moved to the training-hours record, and the July 27 submission to the recommendation page's history."),
        ("August 21, 2026", "The kicker and the model's position note now state the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
    ...
    "comment": [
        ("August 26, 2026", "A fourth at-issue item: the owner statement at 7.35.3.11 (B)(9), which requires a renting patient to obtain the landlord's signed acknowledgment of program participation on the premises before treatment at home, stated in one line linking the rule page note that holds it."),
        ("August 26, 2026", "The hearing mechanics entered from the notice: October 2, 9:00 AM, Harold Runnels Building auditorium, by video conference and telephone, written comment to the office of general counsel by the close of the hearing, comments published within three days; the at-issue items re-based to the August 25 text."),
        ("August 24, 2026", "An accuracy pass corrected the page: the hours item states the recommendation at its August 21 position, standing alone, and reports that the July 23 text raised the didactic module; the Amy Wong-Hope comment is attributed to the July 17 committee meeting; the update stamp carries August 24."),
        ("August 24, 2026", "Re-based to the current state: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules. The kicker, lede, and hearing section state the set-aside, the anticipated October 2 hearing, and the department's statement that comment continues from publication through the hearing."),
        ("August 21, 2026", "The kicker, the lede, and the hearing section now state the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date, and that the department said public comment continues after publication, through the hearing."),
    ...
    "training-hours-record": [
        ("August 26, 2026", "The role tiles, the published-hours section, the waiver table, the benchmark row, and the cost tiles carry the August 25 figures: the shared module at 65 didactic hours with 10 simulated, the practicum unchanged at 100 and 120 with the evaluation gate, the subsections relettered; the middle role reads practitioner with the recommendation's proposed rename noted."),
        ("August 24, 2026", "An accuracy pass corrected the page: the July 9 quotations carry the transcript's exact words with every elision marked, the discretionary waiver is named by its published position at 7.35.3.19 (F), the reciprocity-waiver cite moved to page 5, the Amy Wong-Hope comment is attributed to the July 17 committee meeting, and the renumbered section cross-references were repaired."),
        ("August 24, 2026", "Role vocabulary entered the site's own voice: the middle role is the Licensed Provider, the recommendation's name for the role the published text calls the practitioner, and the screening role is written certifying clinician / medical screener, the recommendation's proposed rename, still being pushed. Verbatim quotes and provision names keep the documents' own words."),
        ("August 24, 2026", "The August 21 committee record entered as section 2, with the later sections renumbered: what the meeting settled, what it left open, and the schedule as restated. The strip and the section state that the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules."),
        ("August 21, 2026", "The status strip now records the August 21 committee review of the subcommittee's revised proposal beside the department's, and states the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
    ...
    "pathways": [
        ("August 26, 2026", "A fourth route: the healing center, which the earlier page never carried although it is the certification a person opens a location under. Thirteen steps from the application at 7.35.3.11 through the operating duties at 7.35.3.20, stating what the rule does not require of the applicant, that it sets no application or certification fee, that a session still needs certified people in the room, and that the rule permits no provider ownership of a center and forbids none. Every starting license now shows it, because none of them is a prerequisite."),
        ("August 26, 2026", "Every route re-based to the August 25 text by tools/sync-pathways.py: the doubled module, the stated license scopes, the relettered waivers, every page anchor re-cited against the new PDF, and the roles at their published names with the recommendation notes reframed against the published text."),
        ("August 24, 2026", "An accuracy pass corrected the page: the step citations point at the pages that carry their provisions, the facilitator entry credential cites 7.35.3.9 (F), the certifications step carries the New Mexico EMT alternative, the controlled-substance step reads settled, kept by the department July 17, and the legend and lede were re-based to the current state."),
        ("August 24, 2026", "Role vocabulary entered the site's own voice: the middle role is the Licensed Provider, the recommendation's name for the role the published text calls the practitioner, and the screening role is written certifying clinician / medical screener, the recommendation's proposed rename, still being pushed. Verbatim quotes and provision names keep the documents' own words."),
        ("August 24, 2026", "Every route re-based to the current state: the July 23 publication and its August 28 hearing were set aside, and the steps read from the last published text until revised rules publish. The what-if lines on the open steps now state the recommendation at its August 21 position, a staged practicum of 102 or 114 hours with the 18-hour case presentation and consultation group inside the total, in place of the July 27 figures of 60 or 70 with 20 consultation hours after."),
        ("August 21, 2026", "The source note now states the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
    ...
    "eligibility": [
        ("August 26, 2026", "Both tables re-based to the August 25 text: the curriculum cells at 65 plus 5 didactic with 10 simulated, the entry credentials carrying the stated license scopes, the scope-test section recording that the text now writes the scopes into the application items, the what-if block reframed against the published figures, and the roles at their published names."),
        ("August 24, 2026", "An accuracy pass corrected the page: the didactic and mentoring pills read open and the controlled-substance pill settled, the alternative-route sentence states the three bases 7.35.3.10 accepts, the sources block frames the July 23 text as the last published text, set aside, and every speaker is named in full."),
        ("August 24, 2026", "Role vocabulary entered the site's own voice: the middle role is the Licensed Provider, the recommendation's name for the role the published text calls the practitioner, and the screening role is written certifying clinician / medical screener, the recommendation's proposed rename, still being pushed. Verbatim quotes and provision names keep the documents' own words."),
        ("August 24, 2026", "The table note and the what-if block re-based to the current state: the July 23 publication was set aside, the tables read from the last published text, and the what-if block states the recommendation at its August 21 position, 102 and 114 practicum hours with the consultation group inside the total and 22 hours as the largest content-area minimum, in place of the July 27 figures."),
        ("August 21, 2026", "The table note now states the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
        ("August 13, 2026", "Copy pass on the three sections added July 31: the scope test, every role the rule names, and the chaplaincy and spiritual care section. Sentences written as argument are restated as reference and headings name their contents; no figure, citation, verdict, or quoted passage changed."),
    ...
    "cs-number": [
        ("August 26, 2026", "The liability section rebuilt on the New Mexico authorities themselves, and its balance corrected: the annotations to 41-5-3 state that an examination a person must undergo as a condition of obtaining something creates a duty to the examinee, which is the closest analog to this role and runs toward exposure; Wilschinsky and Lester hold the third-party duty narrow; Del Sol keeps foreseeability out of the duty question; and the Act's Section 5 is the cannabis certifier clause of 26-2B-4 with two words changed."),
        ("August 26, 2026", "The liability analysis moved out of the collapsed context blocks into a numbered section, rebuilt on New Mexico authority: Rodriguez v. Del Sol holds that foreseeability is not a factor in deciding whether a duty exists, which is the route the out-of-state case relied on, so that case is now stated as illustration rather than prediction; the Act's Section 5 protection is stated as the policy the legislature has already declared; and the Medical Malpractice Act question is stated as open on the definitions in 41-5-3."),
        ("August 26, 2026", "The Medical Psilocybin Act entered the page as a held primary source: the Act's clinician is defined as the provider of the three sessions, so the Act places the appropriateness judgment with the treating provider; the Section 5 exemption protecting a clinician from penalty for recommending the program is quoted; and the open registrant count now records what was searched and the two routes that would produce the number."),
        ("August 26, 2026", "The certification language box now leads with the published text: 7.35.3.8 (B)(8)(c) as published August 25, quoted verbatim, with the note that against the language stated July 17 and published July 23 the August 25 text changed one word, formal consult in pathway (iii) becoming formal consultation, and every other word is identical."),
        ("August 26, 2026", "Rebuilt at a third of the visible length around the routes to the number: an answer block, a no-one-prescribes-psilocybin statement, a route table for each starting license linked to the eligibility and routes pages, the open registrant count stated as open, and the comparators, telemedicine precedents, liability framework, and rural supply demoted into collapsed context blocks with nothing deleted."),
        ("August 26, 2026", "The page carries the third home of the requirement: the amended definition of certifying clinician in 7.35.2.7, published August 25, holds the controlled-substance number inside it. Citations re-anchored to the August 25 PDF, the patient-application cite moved to page 2, and the hearing stated as fixed by notice."),
        ("August 24, 2026", "An accuracy pass corrected the page: the July 9 quotations carry the transcript's exact words with every elision marked, the agency is named the Regulation and Licensing Department, the starting-point count reads thirty-seven, and the standing text reports the set-aside in place of a currently proposed rule."),
        ("August 24, 2026", "Role vocabulary entered the site's own voice: the middle role is the Licensed Provider, the recommendation's name for the role the published text calls the practitioner, and the screening role is written certifying clinician / medical screener, the recommendation's proposed rename, still being pushed. Verbatim quotes and provision names keep the documents' own words."),
        ("August 24, 2026", "The update line and the open-questions section re-based: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules; the requirement stands in the last published text."),
        ("August 21, 2026", "The update line and the open-questions section now state the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
    ...
    "changes": [
        ("August 26, 2026", "A new top layer, August 25 against July 23: the doubled module, the practicum evaluation, the license scopes, the role definitions, and the changes beyond the training sections, with the July 23 layer reframed as history and kept unedited."),
        ("August 24, 2026", "An accuracy pass corrected the page: the July 23 text is framed as the last published text, set aside, rather than the current text, the update stamp carries August 24, and the 7.35.3.10 (D) cite moved to page 5."),
        ("August 24, 2026", "The lede and the hearing note re-based: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules; the diffs read from the last published text until revised rules publish."),
        ("August 21, 2026", "The note under the diff layers now states the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
    ...
    "deferred": [
        ("August 26, 2026", "Re-verified against the August 25 text: every quote re-extracted, the subsections relettered around the new practicum evaluation at 7.35.3.19 (C), which enters as its own provision, and the three not-working-as-written findings recorded as carried forward unchanged."),
        ("August 24, 2026", "An accuracy pass corrected the page: the 7.35.3.19 (B) and 7.35.3.10 (D) cites moved to the pages that carry those subsections, and the description of 7.35.3.19 (A) reports the rule's permissive list, to experience, observe, or conduct supervised facilitation."),
        ("August 24, 2026", "The update line re-based: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules."),
        ("August 21, 2026", "The update line now states the schedule as restated: the department stated at the August 21 committee meeting that revised proposed rules publish August 25 and that the rule hearing, first set for August 28, is anticipated for October 2, with the final notice to fix the date."),
    ...
    "about": [
        ("August 24, 2026", "An accuracy pass corrected the update stamp, which carries the date of the page's latest logged revision."),
    ...
    "specialization": [
        ("August 26, 2026", "The core figures re-based to August 25, 70 didactic plus 10 simulated, and the where-end-of-life-sits note re-read against the new topic list: twenty-six topics, end-of-life still not among them, with the new qualifying-conditions topic named as the nearest counterpart."),
        ("August 24, 2026", "An accuracy pass corrected the page: the last published text is named as such throughout, and the hours cross-reference describes the model's comparison of the recommendation against the last published text."),
