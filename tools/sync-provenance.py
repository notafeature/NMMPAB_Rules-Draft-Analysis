...
REVISIONS = {
    ...
    "rule": [
        ("August 24, 2026", "Reframed as the last published text: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules. The kicker and the lede state the set-aside; the text and annotations are unchanged."),
    ...
    "hours": [
        ("August 24, 2026", "The model re-based to the three current positions: the last published text, the committee's August 21 position of 80 classroom hours and a staged practicum of 102 or 114 with nothing further required after it, and the department's August 21 proposal of 80 classroom hours and the 100 or 120 practicum with two case presentations inside it. The committee position is the default. Dr. Anne Metz's July 17 figures moved to the training-hours record, and the July 27 submission to the recommendation page's history: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules."),
    ...
    "recommendation": [
        ("August 24, 2026", "Rebuilt as the August 21 position in full: the three roles, the three positions in one table, the pathway drawn as a diagram, the 80 didactic hours with the nine content-area minimums, the staged practicum table, the case presentation and consultation checkpoint, the emergency credentials, continuing education, records, and the 2027 transition, the differences from the department's proposal, the position's history from July 17 through August 21, and the Colorado comparison. Sourced to the August 21 meeting, with the absence of its recording tracked in the gaps register: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules."),
    ...
    "pathways": [
        ("August 24, 2026", "The source note re-based: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules; the steps read from the last published text until revised rules publish."),
    ...
    "eligibility": [
        ("August 24, 2026", "The table note re-based: the July 23 publication and its August 28 hearing were set aside, the July 23 text stands as the last published text, and the committee's recommendation stands at its August 21 position, in the department's hands for the revised rules; the tables read from the last published text until revised rules publish."),
